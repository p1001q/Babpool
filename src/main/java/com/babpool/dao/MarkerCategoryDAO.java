...
public class MarkerCategoryDAO {
    ...
    public boolean insertMarkerCategory(int markerId, int categoryId) {
        ...
        try {
            ...
            LogFileFilter.getWriter().println("[MarkerCategoryDAO] insertMarkerCategory() INSERT-Error: " + ex.getMessage());
            return false;
        } finally {
            try {
                if (pstmt != null) pstmt.close();
            } catch (SQLException ex) {
                LogFileFilter.getWriter().println("[MarkerCategoryDAO] insertMarkerCategory() pstmt close Error: " + ex.getMessage());
            }
        }
    }
    ...
    public List<MarkerCategoryMapDTO> getCategoriesByMarkerId(int markerId) {
        ...
        try {
            ...
            LogFileFilter.getWriter().println("[MarkerCategoryDAO] getCategoriesByMarkerId() READ-Error: " + ex.getMessage());
        } finally {
            try {
                if (rs != null) rs.close();
                if (pstmt != null) pstmt.close();
            } catch (SQLException ex) {
                LogFileFilter.getWriter().println("[MarkerCategoryDAO] getCategoriesByMarkerId() 자원 정리 Error: " + ex.getMessage());
            }
        }
        return list;
    }
    ...
    public List<Integer> getMarkerIdsByCategoryId(int categoryId) {
        ...
        try {
            ...
            LogFileFilter.getWriter().println("[MarkerCategoryDAO] getMarkerIdsByCategoryId() READ-Error: " + ex.getMessage());
        } finally {
            try {
                if (rs != null) rs.close();
                if (pstmt != null) pstmt.close();
            } catch (SQLException ex) {
                LogFileFilter.getWriter().println("[MarkerCategoryDAO] getMarkerIdsByCategoryId() 자원 정리 Error: " + ex.getMessage());
            }
        }
        return markerIds;
    }
    ...
    public boolean deleteByMarkerId(int markerId) {
        ...
        try {
            ...
            LogFileFilter.getWriter().println("[MarkerCategoryDAO] deleteByMarkerId() DELETE-Error: " + ex.getMessage());
            return false;
        } finally {
            try {
                if (pstmt != null) pstmt.close();
            } catch (SQLException ex) {
                LogFileFilter.getWriter().println("[MarkerCategoryDAO] deleteByMarkerId() pstmt close Error: " + ex.getMessage());
            }
        }
    }
}
